...
module.exports = {
  ...
  add: async (values) => {
    const data = await Note.create(_.omit(values, _.keys(_.groupBy(strapi.models.note.associations, 'alias'))));
    //await strapi.hook.mongoose.manageRelations('note', _.merge(_.clone(data), { values }));
    return data;
  },
  ...
  edit: async (params, values) => {
    ...
    return Note.update(params, values, { multi: true });
  },
